...
///
///  References:
public struct CoreML_Specification_ItemSimilarityRecommender: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var itemItemSimilarities: [CoreML_Specification_ItemSimilarityRecommender.SimilarItems] = []
  ...
  public var itemStringIds: CoreML_Specification_StringVector {
  ...
  public var itemInt64Ids: CoreML_Specification_Int64Vector {
  ...
  public struct ConnectedItem: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  ///   the similarItemList.
  public struct SimilarItems: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var similarItemList: [CoreML_Specification_ItemSimilarityRecommender.ConnectedItem] = []
...
extension CoreML_Specification_ItemSimilarityRecommender: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: CoreML_Specification_ItemSimilarityRecommender, rhs: CoreML_Specification_ItemSimilarityRecommender) -> Bool {
...
extension CoreML_Specification_ItemSimilarityRecommender.ConnectedItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = CoreML_Specification_ItemSimilarityRecommender.protoMessageName + ".ConnectedItem"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "itemId"),
  ...
  public static func ==(lhs: CoreML_Specification_ItemSimilarityRecommender.ConnectedItem, rhs: CoreML_Specification_ItemSimilarityRecommender.ConnectedItem) -> Bool {
...
extension CoreML_Specification_ItemSimilarityRecommender.SimilarItems: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = CoreML_Specification_ItemSimilarityRecommender.protoMessageName + ".SimilarItems"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "itemId"),
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.itemScoreAdjustment.bitPattern != 0 {
      try visitor.visitSingularDoubleField(value: self.itemScoreAdjustment, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: CoreML_Specification_ItemSimilarityRecommender.SimilarItems, rhs: CoreML_Specification_ItemSimilarityRecommender.SimilarItems) -> Bool {
    if lhs.itemID != rhs.itemID {return false}
