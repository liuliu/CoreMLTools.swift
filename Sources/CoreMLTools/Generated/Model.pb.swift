...
public struct CoreML_Specification_Pipeline: Sendable {
...
public struct CoreML_Specification_PipelineClassifier: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CoreML_Specification_PipelineRegressor: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CoreML_Specification_FeatureDescription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// key/value meta data.
public struct CoreML_Specification_Metadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CoreML_Specification_FunctionDescription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var state: [CoreML_Specification_FeatureDescription] = []
...
public struct CoreML_Specification_ModelDescription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var functions: [CoreML_Specification_FunctionDescription] = []
  ...
  public var trainingInput: [CoreML_Specification_FeatureDescription] = []
...
public struct CoreML_Specification_SerializedModel: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CoreML_Specification_Model: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var classConfidenceThresholding: CoreML_Specification_ClassConfidenceThresholding {
    get {
      if case .classConfidenceThresholding(let v)? = _storage._type {return v}
      return CoreML_Specification_ClassConfidenceThresholding()
    }
  ...
  public enum OneOf_Type: Equatable, Sendable {
    ...
    /// Precision Recall Curve 'container''
    case classConfidenceThresholding(CoreML_Specification_ClassConfidenceThresholding)
    /// feature engineering starts at 600
...
extension CoreML_Specification_FunctionDescription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: CoreML_Specification_FunctionDescription, rhs: CoreML_Specification_FunctionDescription) -> Bool {
    if lhs.name != rhs.name {return false}
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 560: try {
          var v: CoreML_Specification_ClassConfidenceThresholding?
          var hadOneofValue = false
          if let current = _storage._type {
            hadOneofValue = true
