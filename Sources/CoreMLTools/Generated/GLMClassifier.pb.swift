...
public struct CoreML_Specification_GLMClassifier: Sendable {
  ...
  public var postEvaluationTransform: CoreML_Specification_GLMClassifier.PostEvaluationTransform = .logit

  public var classEncoding: CoreML_Specification_GLMClassifier.ClassEncoding = .referenceClass

  ///
  /// Required class label mapping.
  public var classLabels: CoreML_Specification_GLMClassifier.OneOf_ClassLabels? = nil
  ...
  public enum PostEvaluationTransform: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [CoreML_Specification_GLMClassifier.PostEvaluationTransform] = [
      .logit,
      .probit,
    ]
  ...
  public enum ClassEncoding: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [CoreML_Specification_GLMClassifier.ClassEncoding] = [
      .referenceClass,
      .oneVsRest,
    ]
  ...
  public struct DoubleArray: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
