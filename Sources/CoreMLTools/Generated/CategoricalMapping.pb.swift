...
public struct CoreML_Specification_CategoricalMapping: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var mappingType: CoreML_Specification_CategoricalMapping.OneOf_MappingType? = nil
  ...
  public var valueOnUnknown: CoreML_Specification_CategoricalMapping.OneOf_ValueOnUnknown? = nil
