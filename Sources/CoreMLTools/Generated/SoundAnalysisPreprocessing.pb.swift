...
public struct CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Vision feature print type
  public var soundAnalysisPreprocessingType: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.OneOf_SoundAnalysisPreprocessingType? = nil

  public var vggish: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.Vggish {
    get {
...
extension CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing, rhs: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing) -> Bool {
...
extension CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.Vggish: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.protoMessageName + ".Vggish"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.Vggish, rhs: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.Vggish) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
