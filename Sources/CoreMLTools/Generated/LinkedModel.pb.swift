...
public struct CoreML_Specification_LinkedModel: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var linkType: CoreML_Specification_LinkedModel.OneOf_LinkType? = nil

  /// A model located via a file system path
  public var linkedModelFile: CoreML_Specification_LinkedModelFile {
    get {
  ...
  public enum OneOf_LinkType: Equatable, Sendable {
    /// A model located via a file system path
...
public struct CoreML_Specification_LinkedModelFile: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Model file name: e.g. "MyFetureExtractor.mlmodelc"
  public var linkedModelFileName: CoreML_Specification_StringParameter {
  ...
  public var linkedModelSearchPath: CoreML_Specification_StringParameter {
