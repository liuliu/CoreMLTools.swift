...
public struct CoreML_Specification_CustomModel: Sendable {
  ...
  public var parameters: Dictionary<String,CoreML_Specification_CustomModel.CustomModelParamValue> = [:]
  ...
  public struct CustomModelParamValue: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var value: CoreML_Specification_CustomModel.CustomModelParamValue.OneOf_Value? = nil
