...
/// parameter.
public struct CoreML_Specification_OneHotEncoder: Sendable {
  ...
  /// output.
  public var categoryType: CoreML_Specification_OneHotEncoder.OneOf_CategoryType? = nil
  ...
  public var handleUnknown: CoreML_Specification_OneHotEncoder.HandleUnknown = .errorOnUnknown
  ...
  public enum HandleUnknown: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [CoreML_Specification_OneHotEncoder.HandleUnknown] = [
      .errorOnUnknown,
      .ignoreUnknown,
    ]
