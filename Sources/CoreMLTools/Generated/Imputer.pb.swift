...
public struct CoreML_Specification_Imputer: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var imputedValue: CoreML_Specification_Imputer.OneOf_ImputedValue? = nil
  ...
  public var replaceValue: CoreML_Specification_Imputer.OneOf_ReplaceValue? = nil
