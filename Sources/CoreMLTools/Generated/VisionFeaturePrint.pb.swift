...
public struct CoreML_Specification_CoreMLModels_VisionFeaturePrint: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Vision feature print type
  public var visionFeaturePrintType: CoreML_Specification_CoreMLModels_VisionFeaturePrint.OneOf_VisionFeaturePrintType? = nil

  public var scene: CoreML_Specification_CoreMLModels_VisionFeaturePrint.Scene {
    get {
  ...
  public var objects: CoreML_Specification_CoreMLModels_VisionFeaturePrint.Objects {
    get {
  ...
  public struct Scene: Sendable {
    ...
    public var version: CoreML_Specification_CoreMLModels_VisionFeaturePrint.Scene.SceneVersion = .invalid
    ...
    public enum SceneVersion: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      public static let allCases: [CoreML_Specification_CoreMLModels_VisionFeaturePrint.Scene.SceneVersion] = [
        .invalid,
        .sceneVersion1,
        .sceneVersion2,
      ]
  ...
  public struct Objects: Sendable {
    ...
    public var version: CoreML_Specification_CoreMLModels_VisionFeaturePrint.Objects.ObjectsVersion = .invalid
    ...
    public enum ObjectsVersion: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      // The compiler won't synthesize support with the UNRECOGNIZED case.
      public static let allCases: [CoreML_Specification_CoreMLModels_VisionFeaturePrint.Objects.ObjectsVersion] = [
        .invalid,
        .objectsVersion1,
      ]
