...
public enum CoreML_Specification_TreeEnsemblePostEvaluationTransform: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [CoreML_Specification_TreeEnsemblePostEvaluationTransform] = [
    .noTransform,
...
public struct CoreML_Specification_TreeEnsembleParameters: Sendable {
  ...
  public struct TreeNode: Sendable {
    ...
    public enum TreeNodeBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      // The compiler won't synthesize support with the UNRECOGNIZED case.
      public static let allCases: [CoreML_Specification_TreeEnsembleParameters.TreeNode.TreeNodeBehavior] = [
...
public struct CoreML_Specification_TreeEnsembleClassifier: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var postEvaluationTransform: CoreML_Specification_TreeEnsemblePostEvaluationTransform = .noTransform

  /// Required class label mapping
  public var classLabels: CoreML_Specification_TreeEnsembleClassifier.OneOf_ClassLabels? = nil
...
public struct CoreML_Specification_TreeEnsembleRegressor: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
