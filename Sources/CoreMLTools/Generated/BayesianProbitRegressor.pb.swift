...
public struct CoreML_Specification_BayesianProbitRegressor: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var numberOfFeatures: UInt32 = 0

  /// bias term
  public var bias: CoreML_Specification_BayesianProbitRegressor.Gaussian {
  ...
  public var features: [CoreML_Specification_BayesianProbitRegressor.FeatureWeight] = []
  ...
  public var regressionInputFeatureName: String = String()
  ...
  public var optimismInputFeatureName: String = String()

  ///
  /// Set this name to be the same as optional input feature of type double
  /// in the model description you want to use as the samplingScale input
  public var samplingScaleInputFeatureName: String = String()

  ///
  /// Set this name to be the same as optional input feature of type double
  /// in the model description you want to use as the samplingBounds input
  public var samplingTruncationInputFeatureName: String = String()

  ///
  /// name of 'mean' output feature
  public var meanOutputFeatureName: String = String()

  ///
  /// name of 'variance' output feature
  public var varianceOutputFeatureName: String = String()

  ///
  /// name of 'pessimistic' output feature
  public var pessimisticProbabilityOutputFeatureName: String = String()

  ///
  /// name of 'sampled' output feature: samples from the scaled posterior probability distribuiton
  public var sampledProbabilityOutputFeatureName: String = String()

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  ///
  /// Parameterization of a Gaussian distribution
  public struct Gaussian: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct FeatureValueWeight: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var featureValue: UInt32 = 0

    public var featureWeight: CoreML_Specification_BayesianProbitRegressor.Gaussian {
    ...
    public var hasFeatureWeight: Bool {return self._featureWeight != nil}
  ...
  /// it can take
  public struct FeatureWeight: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var featureID: UInt32 = 0

    public var weights: [CoreML_Specification_BayesianProbitRegressor.FeatureValueWeight] = []
...
extension CoreML_Specification_BayesianProbitRegressor.Gaussian: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.precision.bitPattern != 0 {
