...
public struct CoreML_Specification_CoreMLModels_AudioFeaturePrint: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Audio feature print type
  public var audioFeaturePrintType: CoreML_Specification_CoreMLModels_AudioFeaturePrint.OneOf_AudioFeaturePrintType? = nil

  public var sound: CoreML_Specification_CoreMLModels_AudioFeaturePrint.Sound {
    get {
  ...
  /// Audio feature print type
  public enum OneOf_AudioFeaturePrintType: Equatable, Sendable {
  ...
  public struct Sound: Sendable {
    ...
    public var version: CoreML_Specification_CoreMLModels_AudioFeaturePrint.Sound.SoundVersion = .invalid

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public enum SoundVersion: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      public static let allCases: [CoreML_Specification_CoreMLModels_AudioFeaturePrint.Sound.SoundVersion] = [
        .invalid,
        .soundVersion1,
      ]
